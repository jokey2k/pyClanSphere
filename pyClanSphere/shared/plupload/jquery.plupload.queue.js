 ...
 *
 * Slightly modified to be able to catch server errors during upload
 * Modifications (c) 2010 by pyClanSphere Team
 *
	...
	$.fn.pluploadQueue = function(settings) {
		if (settings) {
			this.each(function() {
				...
				function handleStatus(file, res) {
					var actionClass;
										 
					if ($('#' + file.id).hasClass('plupload_failed')) {
						return;						
					}
