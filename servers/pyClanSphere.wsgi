# -*- coding: utf-8 -*-
"""
    pyClanSphere mod_wsgi Runner
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    Run pyClanSphere in mod_wsgi.  For help on configuration have a look at the
    README file.
...
# path to the pyClanSphere application code.
PYCLANSPHERE_LIB = '/usr/lib/pyClanSphere'
...
import sys
import os
if PYCLANSPHERE_LIB not in sys.path:
    sys.path.insert(0, PYCLANSPHERE_LIB)

from pyClanSphere import get_wsgi_app, override_environ_config
